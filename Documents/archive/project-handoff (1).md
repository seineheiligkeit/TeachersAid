...
> ⚠ **HISTORICAL SNAPSHOT — do not read for current state.** This is a stray duplicate of the root
> `project-handoff.md` as of Session 2 (24 Jun 2026), kept only as history. The live handoff (with all
> session updates incl. the 2 Jul 2026 offline-first pivot) is the repo-root **`project-handoff.md`**.
