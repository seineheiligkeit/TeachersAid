...
| [`realien-design.md`](realien-design.md) | **CEFR-leveled communicative reading for modern FS** — the Realie as Sprechanlass (*purpose-appropriate rigor*: invent the facts, vet the language). **Phase 1 + 2a built** (A2 *At the station* + *At the café*). |
