"""Typed profile + derived evidence for the parametric Tiefenregler (P1).
...
P1 intentionally contains only controls that can be derived without authored twins:
scope, alternative computed solution paths, code-generated figures, and
misconception-generated multiple choice.
"""
...
class ParametricMixerProfile(BaseModel):
    """P1 faders for one parametric master.
...
class MixerLintReport(BaseModel):
    """Derived P1 Regler-Lint; WSTF/text evidence joins this model in P3."""
