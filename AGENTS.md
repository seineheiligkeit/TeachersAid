...
- **LLM generation** uses the Anthropic SDK with `Codex-opus-4-8`, adaptive thinking, effort=high
...
they run via Codex). Each emits a `GenWorksheetBody` JSON anchored to **real** catalog competences;
