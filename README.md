...
and Lernarrangements) across all 16 Unterstufe subjects. Working language is English; the product's output
...
python -m pytest -q         # 110 tests, all offline (no API key needed)
...
The dashboard has seven tabs: **Brainstorm** (rough ideas — add your own or "Vorschläge aus Lehrplan",
