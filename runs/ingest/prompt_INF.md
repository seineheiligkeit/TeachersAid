...
algorithm_trace, argumentation, create_produce, data_interpretation, decision_scenario, matching, multiple_choice, open_response, ordering, puzzle, query, table_fill, true_false_justify
## Verankerung
...
## Ausgabe
Schreibe **2 Dateien**, eine pro Kernfrage, nach `runs/ingest/gen_os_2/INF_1.json` … `runs/ingest/gen_os_2/INF_2.json`.
