...
create_produce, data_interpretation, decision_scenario, eroerterung, interpretation, kommentar, matching, multiple_choice, open_response, ordering, table_fill, textanalyse, true_false_justify, zusammenfassung
## Verankerung
...
## Ausgabe
Schreibe **2 Dateien**, eine pro Kernfrage, nach `runs/ingest/gen_os/DEU_1.json` … `runs/ingest/gen_os/DEU_2.json`.
