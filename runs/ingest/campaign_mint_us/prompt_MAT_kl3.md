# KAMPAGNEN-AUFTRAG: Mathematik, Klasse 3 — 3 Arbeitsblätter, EXAKT eines je Kompetenzbereich
...
## Ausgabe
Schreibe **3 Dateien**: `runs/ingest/campaign_mint_us/MAT_kl3_1.json` … `runs/ingest/campaign_mint_us/MAT_kl3_3.json`.
Jede Datei ist **ausschließlich** dieses JSON (kein Fließtext, keine ``` Zäune):

```json
{
  "subject": "Mathematik", "klasse": 3,
