# KAMPAGNEN-AUFTRAG: Mathematik, Klasse 2 — 2 Arbeitsblätter, EXAKT eines je Kompetenzbereich
...
## Ausgabe
Schreibe **2 Dateien**: `runs/ingest/campaign_mint_us/MAT_kl2_1.json` … `runs/ingest/campaign_mint_us/MAT_kl2_2.json`.
Jede Datei ist **ausschließlich** dieses JSON (kein Fließtext, keine ``` Zäune):

```json
{
  "subject": "Mathematik", "klasse": 2,
