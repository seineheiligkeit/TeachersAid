# ZUSATZ-AUFTRAG: Alle 3 Arbeitsblätter sind für **Klasse 1**, und decken die unten gelisteten Kompetenzbereiche ab (≥1 Kernfrage je KB; sei kreativ bei Titel/Kernfrage). Setze `"kompetenzbereich"` exakt auf den jeweiligen KB-Namen.

# Breiten-Generierung: Geographie und wirtschaftliche Bildung — 3 Kernfragen

Du erzeugst **3 verschiedene** Arbeitsblatt-Inhalte (je eine eigene **Kernfrage**) für die
**AHS-Unterstufe** auf österreichischem Lehrplan-Niveau. Sprache: **Deutsch**, AHS-Niveau (nicht zu niedrig).
Wähle **3 klar unterschiedliche Themen/Bereiche** (Breite!), nicht Varianten desselben Themas.
...
## Regeln (für jede der 3 Kernfragen)
...
## Ausgabe
Schreibe **3 Dateien**, eine pro Kernfrage, nach `runs/ingest/gwb_full/GWB_kl1_1.json` … `runs/ingest/gwb_full/GWB_kl1_3.json`.
