# ZUSATZ-AUFTRAG: Alle 2 Arbeitsblätter sind für **Klasse 4**, und decken die unten gelisteten Kompetenzbereiche ab (≥1 Kernfrage je KB; sei kreativ bei Titel/Kernfrage). Setze `"kompetenzbereich"` exakt auf den jeweiligen KB-Namen.
...
## Ausgabe
Schreibe **2 Dateien**, eine pro Kernfrage, nach `runs/ingest/gwb_full/GWB_kl4_1.json` … `runs/ingest/gwb_full/GWB_kl4_2.json`.
