# Breiten-Generierung: Ethik — 2 Kernfragen
...
- `ETH.OS.x.ANA.01` (Kl 5) [dims —]: Die Schülerinnen und Schüler können
- `ETH.OS.x.ANA.02` (Kl 5) [dims —]: ethisch-relevante Texte mit Hilfe fachspezifischer Terminologie und Methoden erschließen und verfassen und
- `ETH.OS.x.ANA.03` (Kl 5) [dims —]: Wissen und Erfahrungen aus unterschiedlichen Fachgebieten und Lebensbereichen aufeinander beziehen und im Lichte ethischer Positionen reflektieren.

### Argumentieren und Urteilen
- `ETH.OS.x.ARG.01` (Kl 5) [dims —]: Die Schülerinnen und Schüler können
- `ETH.OS.x.ARG.02` (Kl 5) [dims —]: moralische und ethische Grundkonzepte darstellen, ihre historischen, sozioökonomischen und kulturellen Zusammenhänge verstehen und
- `ETH.OS.x.ARG.03` (Kl 5) [dims —]: Argumente kritisch prüfen sowie eigenständige und begründete ethische Urteile fällen.

### Basiswissen zu Grund- und Menschenrechten
- `ETH.OS.5.BAS.01` (Kl 5) [dims —]: Menschenwürde, Grundrechte, Kinderrechte

### Beginn des Lebens
- `ETH.OS.6.BEG.01` (Kl 6) [dims —]: Schwangerschaft, Reproduktionsmedizin

### Diversität und Diskriminierung:
- `ETH.OS.7.DIV.01` (Kl 7) [dims —]: Integration und Inklusion; Umgang mit Behinderungen, Stereotypen, Fremdheit, interkulturellen Erfahrungen

### Fernöstliche Religionen und Weltanschauungen
- `ETH.OS.7.FER.01` (Kl 7) [dims —]: Glaubensgrundlagen und moralische Richtlinien im Hinduismus, Buddhismus und Konfuzianismus

### Glück
- `ETH.OS.5.GLU.01` (Kl 5) [dims —]: Glücksvorstellungen, Glücksethiken, Glücksforschung

### Grundbegriffe und Perspektiven der Ethik
- `ETH.OS.5.GRU.01` (Kl 5) [dims —]: Ethik und Moral, Gut und Böse, Tugenden und Laster, Wert und Würde, Freiheit und Verantwortung, Rechte und Pflichten, Gewissen und moralische Emotionen

### Grundkonzepte der Ethik
- `ETH.OS.7.GRU2.01` (Kl 7) [dims —]: Tugendethik, deontologische Ethik, teleologische und konsequentialistische Ethik, utilitaristische Ethik

### Handlungsoptionen entwickeln
- `ETH.OS.x.HAN.01` (Kl 5) [dims —]: Die Schülerinnen und Schüler können
- `ETH.OS.x.HAN.02` (Kl 5) [dims —]: durch Handlungsentwürfe zu moralischen Problemen verantwortungsbewusst und ethisch reflektiert Stellung beziehen und;
- `ETH.OS.x.HAN.03` (Kl 5) [dims —]: die erworbenen Kompetenzen zu eigenen Lebensentwürfen in Beziehung setzen.

### Identitäten und Moralentwicklung
- `ETH.OS.7.IDE.01` (Kl 7) [dims —]: Konzepte von Identität, Theorien der Moralentwicklung

### Interagieren und Sich-Mitteilen
- `ETH.OS.x.INT.01` (Kl 5) [dims —]: Die Schülerinnen und Schüler können
- `ETH.OS.x.INT.02` (Kl 5) [dims —]: eigene Gedankengänge und die anderer sachgemäß und sprachlich sensibel darstellen und
- `ETH.OS.x.INT.03` (Kl 5) [dims —]: Auseinandersetzungen auf argumentativer Grundlage konsens- und dissensfähig führen und mit Meinungsverschiedenheiten und Konflikten gewaltfrei umgehen.

### Judentum, Christentum, Islam
- `ETH.OS.6.JUD.01` (Kl 6) [dims —]: Glaubensgrundlagen, moralische Richtlinien

### Kompetenzmodell
- `ETH.OS.x.KOM.01` (Kl 5) [dims —]: Das Kompetenzmodell gliedert sich in fünf Kompetenzbereiche, die für alle Schulstufen gelten. Die beschriebenen Kompetenzen sind in allen Schulstufen zu entwickeln. Ihr Ausprägungsgrad soll mit aufsteigender Schulstufe komplexer und differenzierter werden.

### Konflikte und Konfliktbewältigung
- `ETH.OS.6.KON.01` (Kl 6) [dims —]: Konfliktforschung, Konfliktlösung, gewaltfreie Kommunikation, Respekt und Toleranz

### Krankheit und Gesundheit, Ende des Lebens
- `ETH.OS.7.KRA.01` (Kl 7) [dims —]: Ärztliches und pflegerisches Berufsethos, Umgang mit Alter, Sterben und Tod

### Krieg und Frieden
- `ETH.OS.8.KRI.01` (Kl 8) [dims —]: Ursachen von Krieg und Terrorismus, Theorien des gerechten Krieges, aktive Friedenssicherung, Völkerrecht, Frieden und Gerechtigkeit

### Liebe und Sexualität
- `ETH.OS.6.LIE.01` (Kl 6) [dims —]: Sex und Gender, moralische Dimensionen von Liebe und Sexualität

### Medien und Kommunikation
- `ETH.OS.6.MED.01` (Kl 6) [dims —]: Pressefreiheit, digitale Welt, Wahrheit und Manipulation

### Menschenwürde, Menschenrechte, Menschenpflichten
- `ETH.OS.7.MEN.01` (Kl 7) [dims —]: Philosophische Grundlagen der Menschenrechte, historische Entwicklung, aktuelle Situation

### Moral und Recht
- `ETH.OS.8.MOR.01` (Kl 8) [dims —]: Naturrecht und positives Recht, ethische Dimensionen des Strafrechts, Recht auf Widerstand, Recht und Gerechtigkeitskonzepte

### Natur und Wirtschaft
- `ETH.OS.5.NAT.01` (Kl 5) [dims —]: Globale und lokale Umweltthemen, globale Gerechtigkeit, nachhaltige Entwicklung, Nachhaltigkeit, Klima, lebensdienliche Wirtschaft, Konsumentinnen- und Konsumentenethik

### Positionen und Begriffe der Ethik
- `ETH.OS.8.POS.01` (Kl 8) [dims —]: Diskursethik, ethischer Relativismus, Verantwortungs- und Gesinnungsethik, Fähigkeitenansatz – gutes Leben, feministische Ethik

### Prinzipien normativer Ethik
- `ETH.OS.6.PRI.01` (Kl 6) [dims —]: Zweck, Nutzen, guter Wille, Gerechtigkeit, Mitleid, Care

### Religion und Weltanschauung
- `ETH.OS.5.REL.01` (Kl 5) [dims —]: Religionsgemeinschaften und säkulare Weltanschauungen in Österreich;
- `ETH.OS.5.REL.02` (Kl 5) [dims —]: Religion und Staat

### Religions- und Moralkritik, Humanismus
- `ETH.OS.8.REL2.01` (Kl 8) [dims —]: Atheismus, Agnostizismus, kritische Religiosität; Esoterik und neue religiöse Bewegungen; säkulare Gesellschaft, humanistische Lebensgestaltung

### Soziale Beziehungen
- `ETH.OS.5.SOZ.01` (Kl 5) [dims —]: Formen von Familie, Partnerschaft und Freundschaft;
- `ETH.OS.5.SOZ.02` (Kl 5) [dims —]: Autoritäten, Vorbilder, Jugendkultur

### Sucht und Selbstverantwortung
- `ETH.OS.5.SUC.01` (Kl 5) [dims —]: Suchtprävention, Abhängigkeit, Verantwortung des Einzelnen und der Gesellschaft

### Technik und Wissenschaft
- `ETH.OS.8.TEC.01` (Kl 8) [dims —]: Verantwortung der Wissenschaften, Technikfolgenabschätzung und -bewertung, Trans- und Posthumanismus

### Umgang mit Tieren
- `ETH.OS.6.UMG.01` (Kl 6) [dims —]: Moralischer Status von Tieren, Tierrechte, Tierschutz

### Wahrnehmen und Perspektiven einnehmen
- `ETH.OS.x.WAH.01` (Kl 5) [dims —]: Die Schülerinnen und Schüler können
- `ETH.OS.x.WAH.02` (Kl 5) [dims —]: Situationen und Probleme der individuellen, sozialen und ökologischen Lebenswelt wahrnehmen, beschreiben und deuten und
- `ETH.OS.x.WAH.03` (Kl 5) [dims —]: sich mit Denkweisen, Wertvorstellungen und Lebenswelten anderer auseinandersetzen sowie die eigene Position einordnen.

### Wirtschaft und Konsum
- `ETH.OS.7.WIR.01` (Kl 7) [dims —]: Markt und Moral, Unternehmensethik, Konsumverhalten

## Erlaubte Dimensionen (`dimensions`, primäre zuerst — Teilmenge dieser Codes)
- `WP` — Wahrnehmen und Perspektiven einnehmen
- `AR` — Analysieren und Reflektieren
- `AU` — Argumentieren und Urteilen
- `IS` — Interagieren und Sich-Mitteilen
- `HO` — Handlungsoptionen entwickeln

## Erlaubte Aufgaben-`kind`-Werte
argumentation, create_produce, data_interpretation, decision_scenario, dilemma, matching, multiple_choice, open_response, ordering, puzzle, table_fill, text_analysis, true_false_justify
## Verankerung
...
## Ausgabe
Schreibe **2 Dateien**, eine pro Kernfrage, nach `runs/ingest/gen_os_2/ETH_1.json` … `runs/ingest/gen_os_2/ETH_2.json`.
Jede Datei ist **ausschließlich** dieses JSON (kein Fließtext, keine ``` Zäune):

```json
{
  "subject": "Ethik", "klasse": <5-8, eine Klasse mit Kompetenzen im gewählten Bereich>,
  ...
  "body": {
    ...
    "sections": [ { "id":"s1","title":"...","throughline":"...","talking_points":["..."],"extensions":["..."],
      "blocks":[ {"role":"task","id":"t1","kind":"<kind>","prompt":"...","payload":null,
        "response":{"mode":"lines","n":3},"cognitive_level":"understand","dimensions":["WP"],
