# Sachverhalt-Autorierung: „Die Industrialisierung" (Geschichte und politische Bildung, 3. Klasse)
...
**Leitfrage (Vorschlag):** Wie verändert die Maschine Arbeit, Stadt und Gesellschaft?

**Kurator-Hinweis:** Spätes 18./19. Jh. Dampfmaschine, Fabrik, Eisenbahn, Urbanisierung, soziale Frage. Datier die echten Eckpunkte; vermeide erfundene Jahreszahlen.
...
## Ausgabe
Schreibe **genau eine** Datei nach `runs/ingest/sv/industrialisierung.json` — **ausschließlich** dieses JSON
(kein Fließtext, keine ``` Zäune), exakt in dieser Form:

```json
{
  "id": "sv-industrialisierung",
  "subject": "Geschichte und politische Bildung",
  "klasse_range": [
    3,
    3
  ],
  "topic": "Die Industrialisierung",
  "leitfrage": "Wie verändert die Maschine Arbeit, Stadt und Gesellschaft?",
  "competences": [
    "<ID aus der Liste>",
    "<weitere ID>"
  ],
