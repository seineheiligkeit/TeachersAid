...
- `noaa_co2_mauna_loa` — Atmosphärische CO₂-Konzentration (Mauna Loa, Jahresmittel). Serien: `verlauf` (CO₂-Konzentration (ppm)). Datenquelle: NOAA Global Monitoring Laboratory (GML) – Mauna Loa CO₂ (Keeling-Kurve), gml.noaa.gov
